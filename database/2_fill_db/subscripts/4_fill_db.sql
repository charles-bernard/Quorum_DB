...
\COPY signal (signal_id, signal_supercategory, signal_family, signal_trivial_name, signal_systematic_name, signal_chemical_formula, peptide_sequence, signal_info) FROM 'input_tables/signal.csv' WITH DELIMITER E'\t' NULL AS '' CSV HEADER;
